    ...
    for entry in os.scandir():
        if entry.is_file():
            if "dsfile" in entry.name and ".wav" in entry.name:
                ...
                command = "unzip models/deepspeech-venv-tflite.zip -d models/; export PATH=models/deepspeech-venv-tflite/bin:$PATH; deepspeech --model deepspeech-0.9.3-models.tflite --audio " + entry.name + " > " + entry.name[:-4] + ".txt"
